...
sobre las ventas mensuales de tres departamentos en los ultimos ocho ano,
...
/* La funcion Lectura se utiliza para leer un arreglo tridimensional
de tipo real de F filas, C columnas y P planos de profundidad. */
...
/* Esta funcion se utiliza para obtener el departamento, mes y ano con
la mayor venta. Escribe tambien el monto de las ventas. */
