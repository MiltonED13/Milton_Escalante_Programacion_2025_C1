...
/* Esta funcion se utiliza para una matriz de tipo entero de F filas
y C columnas. */
{
    int I, J;
...
/* Esta funcion se utiliza para escribir una matriz de tipo entero de
F filas y C columnas - en este caso la traspuesta. */
{
    int I, J;
