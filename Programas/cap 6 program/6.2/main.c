...
void main(void)
{
    int MA[MAX][MAX], MB[MAX][MAX], MC[MAX][MAX]; //Declaracion de los tres arreglos
...
/* La funcion Suma se utiliza para sumar los arreglos y almacenar
el resultado en un tercer arreglo bidimensional. */
...
de tipo entero de F filas y C columnas. */
