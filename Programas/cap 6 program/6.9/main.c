...
El programa, al recibir un arreglo bidimensional cuadrado, asigna
elementos en funcion del modulo (residuo) a un arreglo unidimensional. */
...
/* Esta funcion se utiliza tanto para calcular el modulo entre
el indice del arreglo unidimensional y 3, como para llamar a las funciones
