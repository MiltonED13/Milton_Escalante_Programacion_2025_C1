...
El programa, al recibir un arreglo bidimencional que contiene informacion
...
void main (void)
{
    ...
    while(NAL > MAX || NAL < 1); //Se verifica que el numero de alumnos del grupo sea valido.
...
void Funcion1(float A[][EXA], int T)// Esta funcion se utiliza para obtener el promedio de cada estudiante.
{
    int I, J;
    float SUM, PRO;
