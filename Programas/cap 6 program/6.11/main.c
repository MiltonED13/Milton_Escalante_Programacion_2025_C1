...
/* Esta funcion se utiliza para leer un arreglo bidimensional de tipo real
...
/* Esta funcion se utiliza para leer un arreglo unidimensional de tipo real
de T elementos. */
...
/* La funcion F1 se utiliza para calcular el rendimiento anual de los fondos
de inversion. El resultado se almacena en el arreglo unidimensional V. */
...
/* Esta funcion calcula el promedio anualizado de las acciones de
