...
void main(void)
{
    ...
    while(OPE)
    {
        ...
        case 3:
            ...
            /* Se pasa el parametro por referencia, porque se puede modificar
            el numero de elementos del arreglo en la funcion. */
            break;
        case 4:
            Inventario(INV, TAM);
            break;
...
estructura producto de T elemento. */
{
    int I;
    ...
    while((*T < 30) && (CLA))
    {
        ...
        else
        {
            ...
            else
            {
                for(J = *T; J > I; J--)
                {
                    /*Se inserta el nuevo producto en el arreglo. Se mueven una posicion
...
{
    /* Esta funcion se utiliza para escribir la informacion almacenada en
    -el inventario- un arreglo unidimensional de tipo estructura producto de T elementos. */
