...
void main(void)
{
    ...
    /* Observa que solo el primer componente de una union puede recibir valores
    por medio de este tipo de asignaciones. */
    ...
    de a3 reciben valores a traves de una funcuon. */
    ...
    printf("Alumno 3/n");
    Lectura(&a3); // Se llema a una funcion para leer los campos de la variable a3.
    ...
    printf("%.2f\n", a1.promedio);
    puts(a1.personales.celular); // Observa que escribe el valor del telefono celular asignado.
    puts(a1.personales.correo); // Observa que si tratamos de imprimir el campo correo, escribe basura.

    strcpy(a1.personales.correo, "hgimenes@hotmail.com");
    // Se igresa ahora un valor al segundo campo de la union de la variable a0.

    puts(a1.personales.celular);
    // Ahora escribe basura en el campo del telefono celular.
    puts(a1.personales.correo);
    // Escribe el contenido del campo(hgimenes@hotmail.com).
...
/* La funcion Lectura se utiliza para leer los campos de una variables de tipo
estructura alumno. */
{
