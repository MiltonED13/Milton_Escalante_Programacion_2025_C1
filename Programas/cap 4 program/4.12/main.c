...
El programa, al recibir como datos dos numeros enteros, calcula el
maximo comun divisor de dichos numeros. */
...
//Esta funcion calcula el maximo comun divisor de los numeros N1 y N2.
{
    ...
    while((N1 % I) || (N2 % I))
    {
        ...
        el ciclo se detiene ya que se habra encontrado el maximo comun divisor.*/
        I--;
    }
    return I;
}
