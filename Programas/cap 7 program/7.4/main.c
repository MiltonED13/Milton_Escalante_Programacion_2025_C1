...
void main (void)
{
    ...
    apunta cad1. Lyego podemos modificar el contenido de esta posicion de memoria
    ...
    puts(cad2);
    gets(cad2);
    /* El valor de la cadena (declarada como cadena[longitur]) se puede modificar
    por medeio de lecturas o utilizando funciones de la biblioteca string.h
    (ejemplo 7.6). */
    puts(cad2);
    cad2[10] = "Guatemala";
