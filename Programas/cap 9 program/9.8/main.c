...
typedef struct // Declaracion de la estructur alumno.
{
    int matricula;
    char nombre[20];
    int carrera;
...
void main(void)
{
    ...
    if ((ar = fopen("C:\\Archivos de Codeblock\\ad1.dat", "w")) != NULL) //if ((ar = fopen("C://temp//ad1.dat", "w")) != NULL)
    {
        escribe(ar);
    }
    else
...
void escribe(FILE *ap)
{
    ...
    while(r)
    {
        ...
        utilizara para indicar la variable tipo estructura que se desea almacenar; el
