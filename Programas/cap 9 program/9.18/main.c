...
{
    FILE *ar, *ar1, *ar2;
    ar = fopen("C:\\Archivos de Codeblock\\arc9.dat", "r");
    ar1 = fopen("C:\\Archivos de Codeblock\\arc10.dat", "r");
    ar2 = fopen("C:\\Archivos de Codeblock\\arc11.dat", "w");
...
ordenados en funcion de la matricula. */
{
    ...
    {
        if(b)
        /*Si la bandera b esta encendida, se lee del archivo ar la
        ...
        if(b1)
        /* Si la bandera b1 esta encendida, se lee del archivo ar
