...
void main(void)
{
    ...
    ap = fopen("C:\\Archivos de Codeblock\\alu1.dat", "r");
    /* Observa que los archivos car1.dat, car2.dat, car3.dat, car4.dat y car5.dat
    se abren en la modalidad para escribir y leer. */

    c1 = fopen("C:\\Archivos de Codeblock\\car1.dat", "w+");
    c2 = fopen("C:\\Archivos de Codeblock\\car2.dat", "w+");
    c3 = fopen("C:\\Archivos de Codeblock\\car3.dat", "w+");
    c4 = fopen("C:\\Archivos de Codeblock\\car4.dat", "w+");
    c5 = fopen("C:\\Archivos de Codeblock\\car5.dat", "w+");
...
las carreras de la universidad. */
{
    ...
    while(!feof(ap))
    {
        //Se analaiza si el candidato es admitido a la universidad.
...
alumnos admitidos en cada una de las carreras. */
{
    ...
    sum = 0;
    rewind(c1);
    /* Es importante posicionarse al inicio del archivo, pues
    de los contrario se generia un error al ejercutar el programa. */
