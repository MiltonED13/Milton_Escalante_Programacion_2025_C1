...
void main(void)
{
    ...
    if((ar = fopen("C:\\Archivos de Codeblock\\ad5.dat", "r+")) != NULL)
...
Actualiza ademas el archivo correspondiente. */
{
    ...
    t = sizeof(empleado);
    //La funcion seizeof se utiliza para conocer el tamano de la estructura empleado.
    ...
    while(!feof(ap))
    {
        ...
        obtener el numero de bloques de hay exactamente debajo de nuestra
        posicion. */
        ...
        if (sum > 100000)
        {
            ...
            Esta instruccin no deberia ser necesaria, pero la funcion
