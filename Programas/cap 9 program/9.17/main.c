...
minuscula- la reemplaza por su forma correcta y escribe la cadena en otro archivo. */
...
void main(void)
{
    ...
    ar = fopen("C:\\Archivos de Codeblock\\arc.txt", "r"); //Se abre el archivo arc.txt para lectura.
    ap = fopen("C:\\Archivos de Codeblock\\arc1.txt", "w"); //Se abre el archivo arc1.txt para escritura.
