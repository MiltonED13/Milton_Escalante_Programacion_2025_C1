...
{
    FILE *ap;
    if ((ap = fopen("C:\\Archivos de Codeblock\\arc2.txt", "r")) != NULL)
    {
        sumypro(ap);
...
numeros. */
{
    ...
    while(!feof(ap1))
    {
        ...
        contiene numeros reales a un valor de tipo double. Si la cadena comeinza
        con otro caracter o no contiene numeros, regresa 0 o el valor queda
        indefinido. */
