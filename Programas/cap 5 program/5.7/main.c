...
de N elementos, obtiene como salida ese mismo arreglo pero sin los elementos repetidos. */

void Lectura(int *, int); //Prototipos de funciones.
void Imprime (int *, int);
void Elimina (int *, int*);
/* Observa que en el prototipo de Elimina, el segundo parametro es por
referencia. Esto, porque el tamano del arreglo para disminuir. */

void main(void)
{
    int TAM, ARRE[100];
    /* Se escribe un do-while para verificar que el tamano del arreglo
...
unidimensionales de T elemento de tipo entero. */
{
    int I = 0, K, L;
